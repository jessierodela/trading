...
Assets analyzed: 5 of 10 requested (BTC-USD, ETH-USD, SOL-USD, LINK-USD, AVAX-USD).
...
Instrument: symbol=SPY, exchange=COINBASE, assetType=EQUITY, dataSource=postgres

SPY skipped — no stored 1h bars available for configured data source (postgres).
Equity OHLCV ingestion is not implemented yet; add an equity data source and backfill before this asset can be analyzed.

## QQQ

Instrument: symbol=QQQ, exchange=COINBASE, assetType=EQUITY, dataSource=postgres

QQQ skipped — no stored 1h bars available for configured data source (postgres).
Equity OHLCV ingestion is not implemented yet; add an equity data source and backfill before this asset can be analyzed.

## AAPL

Instrument: symbol=AAPL, exchange=COINBASE, assetType=EQUITY, dataSource=postgres

AAPL skipped — no stored 1h bars available for configured data source (postgres).
Equity OHLCV ingestion is not implemented yet; add an equity data source and backfill before this asset can be analyzed.

## MSFT

Instrument: symbol=MSFT, exchange=COINBASE, assetType=EQUITY, dataSource=postgres

MSFT skipped — no stored 1h bars available for configured data source (postgres).
Equity OHLCV ingestion is not implemented yet; add an equity data source and backfill before this asset can be analyzed.

## NVDA

Instrument: symbol=NVDA, exchange=COINBASE, assetType=EQUITY, dataSource=postgres

NVDA skipped — no stored 1h bars available for configured data source (postgres).
Equity OHLCV ingestion is not implemented yet; add an equity data source and backfill before this asset can be analyzed.
