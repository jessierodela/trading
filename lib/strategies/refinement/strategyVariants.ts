...
export const momentumContinuationRefinedV1 = createGatedStrategy({
  ...
  allowedRegimes: ["TREND_UP", "LOW_VOL"],
  blockedRegimes: ["TREND_DOWN", "NEWS_SHOCK"],
  minRegimeReliability: 0.6,
  gates: [
    "trend_confirmed",
...
export const breakoutExpansionRefinedV1 = createGatedStrategy({
  ...
  allowedRegimes: ["TREND_UP", "HIGH_VOL", "NEWS_SHOCK"],
  blockedRegimes: ["LOW_VOL", "CHOP"],
  minRegimeReliability: 0.6,
  gates: [
...
export const meanReversionRefinedV1 = createGatedStrategy({
  ...
  allowedRegimes: ["LOW_VOL", "CHOP", "HIGH_VOL"],
  blockedRegimes: ["TREND_DOWN", "NEWS_SHOCK"],
  minRegimeReliability: 0.55,
  gates: [
    "oversold_confirmed",
